        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            <p className="text-gray-300 text-2xl md:text-3xl leading-snug mb-0 pl-[20] ml-8">
              <span className="font-bold text-white">At SPARKTECH,</span> At
              SPARKTECH, we specialize in crafting innovative strategies that
              help brands connect with their audience and achieve measurable
              growth. Our expert team is dedicated to transforming ideas into
              results, turning clicks into loyal customers. Let us help you
              create a lasting digital presence and unlock your brand's full
              potential.
            </p>
          </div>
            ...
            >
              ...
              {isMissionOpen && (
                <p className="text-gray-400 mt-4">
                  ...
                  solutions that empower businesses and enhance user
                  experiences.
                </p>
              )}
            </div>
        ...
        <div className="bg-black px-6 py-20 ">
          <div className="max-w-6xl mx-auto md:px-5">
            ...
            <p className="text-gray-400 mb-30 text-2xl ">
              At Spark Tech, our leadership is driven by a passion for
              innovation and a deep understanding of digital transformation. Our
              founder leads by example, constantly pushing the boundaries to
              help clients thrive in a fast-evolving tech landscape.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="text-gray-400 max-w-xl text-2xl leading-relaxed">
                ...
                behind Spark Tech. With a background in full-stack development
                and a knack for turning complex challenges into simple
                solutions, he has led the company to new heights. His leadership
                is built on innovation, integrity, and relentless focus on
                quality.
              </div>
            </div>
          </div>
