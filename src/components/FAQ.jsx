...
export const FAQ = () => {
  ...
  return (
    <section className="py-20 px-60 bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2
            className="text-white text-6xl font-normal leading-tight tracking-tight max-w-lg mx-auto"
            style={{
        ...
        <div className="max-w-5xl mx-auto space-y-5">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="rounded-[30px] bg-white/5 backdrop-blur-sm border border-black/10"
            >
              <button
              ...
              >
                <h3
                  className="text-white text-base font-light leading-relaxed tracking-tight pr-4"
                  style={{
                    fontFamily: 'Unbounded, "Unbounded Placeholder", sans-serif',
                    fontSize: "16px",
                    fontWeight: 300,
                ...
                <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#F58327] flex items-center justify-center">
                  <svg
                    className={`w-3.5 h-3.5 transition-transform duration-200 ${activeIndex === index ? "rotate-180" : ""}`}
                    fill="none"
                    viewBox="0 0 14 14"
                  >
                    <path
